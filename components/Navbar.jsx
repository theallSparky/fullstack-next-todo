...
const CTAs = () => {
  return (
    <div className="flex items-center gap-3">
      ...
      <Link
        href="/signup"
        className="rounded-lg border-2 border-blue-500 bg-blue-500 px-4 py-2 font-semibold text-black transition-colors hover:border-blue-600 hover:bg-blue-600 hover:text-white"
      >
        Sign Up
      </Link>
    </div>
